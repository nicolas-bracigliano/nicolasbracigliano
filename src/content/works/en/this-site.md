...
iterations:
  ...
  - rev: 'v1.3'
    date: '2026-05-23'
    note: 'The first content routes reach prototype parity: the colophon (this page), About, the Numbered bench tour, and the Misplaced Letter 404.'
  - rev: 'v1.0'
    date: '2026-05-22'
    status: shipping
...
Every other entry here is something I made. This one is the shelf the rest sit on. It isn't a portfolio; the portfolio is the work itself. The site is the colophon: a place to keep the work, the drafts, and the receipts, with the tools left in view on purpose.
...
Everything is written twice, English and Spanish, composed in parallel rather than translated. It's ongoing by design: the colophon updates whenever the stack moves, and the stack keeps moving.
